...
public class Account {
	...
	// TODO: Task3 
	// replace the null with a lambda expression
	public static AddMaker maker = (N)->{return((Account a)->{a.balance+=N;});};
	...
	public static int getMaxAccountID(List<Account> accounts) {
		// TODO: Task4 
		// replace the null with a lambda expression
		Account maxOne = accounts.stream().reduce(new Account(0, -100), (account,element)->{if(element.balance>=account.balance) {return element;}else return account;});
