...
public class Hospital {
    ...
    public boolean addPatient(Patient patient) {
        ...
        case Critical:
        		cap.decreaseCapacity(SymptomLevel.Critical);
        		CriticalPatients.add(patient);
        		return true;
        	
             
        case Moderate:
        		cap.decreaseCapacity(SymptomLevel.Moderate);
        		ModeratePatients.add(patient);
        		return true;
        	
        case Mild:
        		cap.decreaseCapacity(SymptomLevel.Mild);
        		MildPatients.add(patient);
        		return true;
    ...
    public boolean releasePatient(Patient patient) {
        switch (patient.getSymptomLevel()) {
        case Critical:
        		cap.increaseCapacity(SymptomLevel.Critical);
        		CriticalPatients.remove(patient);
        		return true;
            
        case Moderate:
        		cap.increaseCapacity(SymptomLevel.Moderate);
        		ModeratePatients.remove(patient);
        		return true;
        	
        case Mild:
        		cap.increaseCapacity(SymptomLevel.Mild);
        		MildPatients.remove(patient);
        		return true;
        }
        return false;
    }
